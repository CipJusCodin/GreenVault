...
public class AdminController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        Model.getInstance().getViewFactory().getAdminSelectedMenuItem().addListener((observableValue, oldVal, newVal) -> {    //this will respond to changes in the selected menu item
            switch (newVal) {                                                                                //This line checks the value of the newly selected menu item using a switch statement
