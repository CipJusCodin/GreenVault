...
public class CreateClientController implements Initializable {
    ...
    private void emptyFields() {
        fName_fld.setText("");
        lName_fld.setText("");
        password_fld.setText("");                                                //This method is used to reset or clear all input fields and checkboxes after a client
        pAddress_box.setSelected(false);                                          //is created. It sets the text fields to empty strings and resets the selected state of the checkboxes.
